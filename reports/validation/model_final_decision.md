...
The frozen final nine-feature two-stage burned-share regression is retained as the project's
...
The final nine-feature model is implemented as a two-stage scikit-learn regression model. The
...
On the one frozen final temporal test (T=2022-2024), the final nine-feature
...
main limitation: the final model's mean prediction for that year was 0.00544 while
...
After the final evaluation was recorded, the unchanged final nine-feature
...
legacy internal artifact filename for the final model. Its feature order, training
