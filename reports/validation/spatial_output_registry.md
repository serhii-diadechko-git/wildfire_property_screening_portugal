...
| Historical residential wildfire-exposure screening | `data/processed/spatial_outputs/historical_residential_wildfire_exposure_screening.gpkg`, layer `historical_exposure_screening` | EPSG:3763 | 89,112 | `cell_id`, 2016-2025 recurrence, recurrence-only historical band, CLC/slope context, predominant official ICNF hazard class, evidence status | Final historical/descriptive comparison layer; not a prediction, probability, safety guarantee, official-map validation, or purchase recommendation. |
