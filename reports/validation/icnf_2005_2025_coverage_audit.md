# ICNF 2005–2025 raw coverage audit

Raw ZIP files were inspected in place; Shapefile members were extracted only to system temporary directories.

| Archive / layer | Features | Geometry | CRS | Sidecars | Empty / invalid | Bounds | Ano values | Usability |
|---|---:|---|---|---|---:|---|---|---|
| `ardida_2000_2008.zip` / `ardida_2000_2008.shp` | 10981 | MultiPolygon,Polygon | EPSG:3763 | True | 0 / 201 | (-118221.7, -293185.01, 158553.45, 272568.56) | 2000, 2001, 2002, 2003, 2004, 2005, 2006, 2007, 2008 | Yes: polygon, CRS/schema require derived validation |
...
| `ardida_2016.zip` / `ardida_2016.shp` | 2838 | MultiPolygon,Polygon | EPSG:3763 | True | 0 / 111 | (-105419.89, -274825.54, 124621.86, 269034.11) | 2016 | Yes: polygon, CRS/schema require derived validation |
| `ardida_2017.zip` / `ardida_2017.shp` | 2765 | MultiPolygon,Polygon | EPSG:3763 | True | 0 / 27 | (-111304.99, -291967.6, 160375.41, 273254.83) | 2017 | Yes: polygon, CRS/schema require derived validation |
| `ardida_2018.zip` / `ardida_2018.shp` | 537 | MultiPolygon,Polygon | EPSG:3763 | True | 0 / 24 | (-116591.13, -293879.59, 141017.39, 266471.17) | 2018 | Yes: polygon, CRS/schema require derived validation |
| `ardida_2019.zip` / `ardida_2019.shp` | 1725 | MultiPolygon,Polygon | EPSG:3763 | True | 0 / 54 | (-108599.87, -284075.18, 152116.52, 272048.81) | 2019 | Yes: polygon, CRS/schema require derived validation |
| `ardida_2020.zip` / `ardida_2020.shp` | 1777 | MultiPolygon,Polygon | EPSG:3763 | True | 0 / 22 | (-115110.0, -292837.02, 158820.75, 273912.46) | 2020 | Yes: polygon, CRS/schema require derived validation |
| `ardida_2021.zip` / `ardida_2021.shp` | 918 | MultiPolygon,Polygon | EPSG:3763 | True | 0 / 1 | (-100174.03, -289672.36, 155543.13, 271417.59) | 2021 | Yes: polygon, CRS/schema require derived validation |
