...
These sources support the retained final nine-feature model schema. Additional sources are not introduced without a separately documented research version and validation decision.
