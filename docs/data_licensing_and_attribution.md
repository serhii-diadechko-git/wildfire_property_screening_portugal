...
| [Esri World Topographic and World Imagery basemaps](https://support.esri.com/en-us/knowledge-base/what-is-the-correct-way-to-cite-an-arcgis-online-basema-000012040) | Online service; attribution and service terms apply | The local viewer requests Esri's public tile endpoints only during modest interactive viewing. Esri requires source attribution for service use; the provider's [website and service terms](https://www.esri.com/en-us/legal/terms/web-site-service) apply. | Keep the map's Esri/source attribution visible. Do not treat the public endpoint as a production entitlement. A hosted/commercial deployment requires an Esri terms, licensing, traffic, and attribution review. |
